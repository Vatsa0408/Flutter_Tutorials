...
import 'package:truck_rental/ui/search_list.dart';
import 'package:truck_rental/constants/styles.dart';
import 'package:truck_rental/models/form_data/search.dart';
import 'package:truck_rental/ui/partials/glow_button.dart';
import 'package:truck_rental/ui/partials/gradient_bg.dart';
import 'package:truck_rental/ui/partials/custom_input.dart';
                    ...
                    children: <Widget>[
                      ...
                      Flexible(
                        child: StreamBuilder(
                          ...
                          builder:
                              (_, AsyncSnapshot<String> startTimeSnapshot) =>
                                  CustomInput(
                    ...
                    children: <Widget>[
                      Flexible(
                        child: StreamBuilder(
                          ...
                          builder: (_, AsyncSnapshot<String> endDateSnapshot) =>
                              CustomInput(
                      ...
                      Flexible(
                        child: StreamBuilder(
                          ...
                          builder: (_, AsyncSnapshot<String> endTimeSnapshot) =>
                              CustomInput(
